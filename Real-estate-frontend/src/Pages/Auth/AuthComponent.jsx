...
const AuthComponent = () => {
    ...
    const validationSchema = yup.object({
        ...
        password: yup.string().required('Password Is required').min(8, 'Password Must At Least 8 Charactors Long')
    })
                ...
                <div className="form-container sign-in-container absolute top-0 left-0 w-1/2 h-full flex flex-col items-center justify-center p-8">
                    <Formik>
                        <form action="#">
                            ...
                            <input type="email" placeholder="Email" className="w-[150%] outline-none p-2 my-2 bg-gray-200 rounded" />
                            <input type="password" placeholder="Password" className="w-[150%] outline-none p-2 my-2 bg-gray-200 rounded" />
