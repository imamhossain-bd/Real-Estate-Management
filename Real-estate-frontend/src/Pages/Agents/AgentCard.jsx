...
const AgentCard = ({ allAgent }) => {
    ...
    return (
        <div className=''>
            ...
            <div className="w-[370px] rounded-xl shadow-md hover:shadow-xl transition-all duration-500 bg-white overflow-hidden">
                {/* Image Section */}
                <div className="relative">
                    <img className="w-full h-[320px] object-cover" src={image} alt="Agent" />
                    {/* Floating Plus Button */}
                    <div className="absolute mt-[-1.5rem] right-16 bg-transparent rounded-full z-30 shadow-md cursor-pointer">
                        <div className="tooltip-container">
                            <span className="text">
                                <svg xmlns="http://www.w3.org/2000/svg" width={22} height={22} viewBox="0 0 448 512"><path d="M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32l0 144L48 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l144 0 0 144c0 17.7 14.3 32 32 32s32-14.3 32-32l0-144 144 0c17.7 0 32-14.3 32-32s-14.3-32-32-32l-144 0 0-144z" /></svg>
                            </span>
                ...
                <a href={`/singleagent/${id}`}>
                    <div className="p-4 mt-8 text-center">
                        <h2 className='text-3xl font-bold hover:text-[#ff5a3c]'>{name}</h2>
